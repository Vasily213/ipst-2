...
!function (e, n) {
    ...
    var r = "fullpage-wrapper", a = "." + r, l = "fp-scrollable", s = "." + l, c = "fp-responsive",
        ...
        m = "fp-completely", g = "." + m, S = ".section", w = "fp-section", y = "." + w, b = y + v, C = y + ":first",
        T = y + ":last", x = "fp-tableCell", k = "." + x, L = "fp-auto-height", M = "fp-normal-scroll", A = "fp-nav",
        E = "#" + A, I = "fp-tooltip", O = "." + I, B = "fp-show-active", H = ".slide", R = "fp-slide", D = "." + R,
        z = D + v, P = "fp-slides", F = "." + P, V = "fp-slidesContainer", U = "." + V, W = "fp-table",
        q = "fp-slidesNav", Y = "." + q, X = Y + " a", N = "fp-controlArrow", j = "." + N, K = "fp-prev", Q = "." + K,
        G = N + " " + K, J = j + Q, Z = "fp-next", $ = "." + Z, _ = N + " " + Z, ee = j + $, ne = e(n), te = e(t),
    ...
    e.fn.fullpage = function (l) {
        ...
        function ve() {
            ...
            if (!l.autoScrolling || l.scrollBar) {
                ...
                if (me(i) && (e(b).hasClass(m) || e(b).addClass(m).siblings().removeClass(m)), n = e(s).eq(r), !n.hasClass(p)) {
                    lt = !0;
                    var f = e(b), u = f.index(y) + 1, h = an(n), v = n.data("anchor"), g = n.index(y) + 1,
                        S = n.find(z);
                    if (S.length) var w = S.data("anchor"), C = S.index();
        ...
        function xe(t) {
            var i = (new Date).getTime(), r = e(g).hasClass(M);
        ...
        function Me(e) {
            var n = e.position(), t = n.top, o = n.top > pt, i = t - Qn + e.outerHeight();
        ...
        function Ve() {
            if (!lt && !l.lockAnchors) {
                var e = n.location.hash.replace("#", "").split("/"), t = decodeURIComponent(e[0]),
                    o = decodeURIComponent(e[1]), i = "undefined" == typeof Wn,
        ...
        function Ze(n, t) {
            var i = t.position(), r = t.index(), a = n.closest(y), s = a.index(y), c = a.data("anchor"), d = a.find(Y),
                f = wn(t), u = a.find(z), h = Gn;
            if (l.onSlideLeave) {
        ...
        var Wn, qn, Yn, Xn = !1,
            ...
            jn = "ontouchstart" in n || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, Kn = e(this),
            Qn = ne.height(), Gn = !1, Jn = !0, Zn = !0, $n = [], _n = {};
